...
exports = O.init('control', 'flowMeter');
...
/*
  ...
  entry.shard.post(entry.dval.master, {registerPins: pins});
  */
};
...
//    O.log.unhandled('Invalid PIN', {entry: that.toString(), index: action.data.index, expected: that.data.pin});
