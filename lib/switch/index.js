...
exports.init = function() {  // {{{2
  ...
  this.ddef = O.new('ose/lib/field/object')();
  this.ddef.text('name', {required: true});
  this.ddef.lookup('parent');
  this.ddef.lookup('master');  // {{{3
  /**
  ...
  this.ddef.millitime('debounce');  // {{{3
  /**
   * Debounce timeout
   *
